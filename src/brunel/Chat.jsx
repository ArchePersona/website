...
function Chat() {
  ...
  const pairs = useMemo(() => {
    ...
    for (const m of messages) {
      ...
      else out.push({ user: null, userTs: null, userAttachment: null, assistant: m.content, plain: m.plain || null, assistantTs: m.ts, assistantState: m.state || "St0", assistantMode: m.mode || "011" });
    }
  ...
  const drawerClass = `${drawerClosing ? "closing" : "open"} ${drawerKind === "cybrary" ? "cybrary-drawer" : "works-drawer"}`;
